...
2. Set `EMBEDDING_PROVIDER=gemini` and `EMBEDDING_MODEL` to your chosen Gemini embedding model (default: `gemini-embedding-001`, truncated to `EMBEDDING_DIMENSION` / 768 for pgvector).
